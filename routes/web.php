...
Route::get('admin/plan/list', [App\Http\Controllers\admin\MemberPlanController::class, 'list']);
...
Route::get('admin/diet/list',[App\Http\Controllers\admin\DietController::class, 'list']);
Route::get('admin/dirt/add', [App\Http\Controllers\admin\DietController::class, 'add']);

Route::get('admin/diet/workout',[App\Http\Controllers\admin\DietController::class, 'worklist']);
