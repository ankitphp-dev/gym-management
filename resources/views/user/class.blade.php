            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="class-details-text">
                        <div class="cd-pic">
                            <img src="{{ asset('user/img/classes/class-details/class-detailsl.jpg') }}" alt="">
                        </div>
                        <div class="cd-text">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="cd-trainer-pic">
                                        <img src="{{ asset('user/img/classes/class-details/trainer-profile.jp') }}g" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                ...
                <div class="col-lg-4 col-md-8">
                    <div class="sidebar-option">
                        ...
                        <div class="so-latest">
                            ...
                            <div class="latest-large set-bg" data-setbg="{{ asset('user/img/letest-blog/latest-1.jpg') }}">
                                <div class="ll-text">
                            ...
                            <div class="latest-item">
                                <div class="li-pic">
                                    <img src="{{ asset('user/img/letest-blog/latest') }}-2.jpg" alt="">
                                </div>
                                <div class="li-text">
                            ...
                            <div class="latest-item">
                                <div class="li-pic">
                                    <img src="{{ asset('user/img/letest-blog/latest') }}-3.jpg" alt="">
                                </div>
                                <div class="li-text">
                            ...
                            <div class="latest-item">
                                <div class="li-pic">
                                    <img src="{{ asset('user/img/letest-blog/latest') }}-4.jpg" alt="">
                                </div>
                                <div class="li-text">
                            ...
                            <div class="latest-item">
                                <div class="li-pic">
                                    <img src="{{ asset('user/img/letest-blog/latest') }}-5.jpg" alt="">
                                </div>
                                <div class="li-text">
                        ...
                        <div class="so-banner set-bg" data-setbg="{{ asset('user/img/sidebar-banner.jpg') }}">
